...
import de.htwberlin.mauterhebung.MautProcedureImpl;
...
public class MautServiceTest {
	...
	private static IMauterhebung maut = new MautProcedureImpl();
	...
	public void testMauterhebung_3() throws Exception {
		...
		// Achszahl. Der Fahrer bezahlt also weniger Maut für die
		// Streckenbefahrung als er müsste. Dies führt zu einer
		// InvalidVehicleDataException.
	...
	public void testMauterhebung_4() throws Exception {
		// Das Fahrzeug ist bekannt und im manuellen Verfahren unterwegs.
		// Auch die Mautkategorie stimmt. Allerdings führt eine Doppelbefahrung
	...
	public void testMauterhebung_5() throws Exception {
		...
		// die Kontrolldaten stimmen mit den gebuchten Daten überein.
	...
	public void testMauterhebung_6() throws Exception {
		// Das Fahrzeug ist bekannt & aktiv, sowie mit einem Fahrzeuggerät
		// ausgestattet und im Automatischen Verfahren unterwegs.
		// Die Höhe der Maut wird anhand des gefahrenen Abschnitts und der
